init python:
	...
	register_place(   "enter", "forest_path-5", 920, 565, 40, 160, to=["right", "forest_path-5", "enter"])
	register_place(   "enter", "forest_path-9", 0, 555, 40, 160, to=["left", "forest_path-9", "enter", to_forward])
	register_place(   "enter", "ikarus", 400, 580, 40, 30, to=["up", "ikarus", "enter"])
	...
	register_place(   "forest_path-6", "left", 0, 120, 40, 80, to=["left", "forest_path-6", "up"])
	register_place(   "forest_path-6", "tennis", 150, 376, 90, 40, to=["down", "tennis", "forest_path-6"])
	register_place(   "forest_path-6", "up", 310, 0, 90, 40, to=["up", "forest_path-6", "left"])
	...
	register_place(   "forest_path-7", "right", 504, 80, 40, 90, to=["right", "forest_path-7", "up"])
	register_place(   "forest_path-7", "up", 210, 0, 90, 40, to=["up", "forest_path-7", "right"])
	
	register_location("forest_path-8", "images/locations/forest_path-8/", False, 544, 416)
	register_place(   "forest_path-8", "down", 210, 376, 90, 40, to=["down", "forest_path-8", "right"])
	register_place(   "forest_path-8", "forest_path-7", 400, 0, 100, 40, to=["up", "forest_path-7", "forest_path-8"])
	register_place(   "forest_path-8", "right", 504, 120, 40, 90, to=["right", "forest_path-8", "down"])
