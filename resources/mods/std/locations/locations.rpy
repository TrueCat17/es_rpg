init python:
	...
	register_place(   "admin", "admin_bench_pos", 348, 851, 2, 2)
	...
	register_place(   "admin", "lamp_pos-3", 978, 985, 2, 2)
	register_place(   "admin", "lamp_pos-4", 612, 985, 2, 2)
	register_place(   "admin", "lamp_pos-5", 348, 985, 2, 2)
	...
	register_place(   "boat_station", "boat_station_bench_pos", 1001, 1301, 2, 2)
	register_place(   "boat_station", "boat_station_tabouret_pos", 511, 427, 2, 2)
	...
	register_place(   "clubs", "clubs_bench_pos", 849, 349, 2, 2)
	register_place(   "clubs", "cluster", 200, 1300, 2, 2)
	register_place(   "clubs", "mus_club_column_pos-1", 773, 399, 2, 2)
	register_place(   "clubs", "mus_club_column_pos-2", 836, 399, 2, 2)
	register_place(   "clubs", "mus_club_column_pos-3", 899, 399, 2, 2)
	register_place(   "clubs", "mus_club_column_pos-4", 962, 399, 2, 2)
	register_place(   "clubs", "mus_club_column_pos-5", 1025, 399, 2, 2)
	register_place(   "clubs", "mus_club_rails_pos-1", 804, 399, 2, 2)
	register_place(   "clubs", "mus_club_rails_pos-2", 867, 399, 2, 2)
	register_place(   "clubs", "mus_club_rails_pos-3", 930, 399, 2, 2)
	register_place(   "clubs", "mus_club_rails_pos-4", 1056, 399, 2, 2)
	...
	register_place(   "crossroad", "crossroad_bench_pos", 156, 340, 2, 2)
	...
	register_place(   "enter", "before_gates", 410, 305, 156, 50)
	...
	register_place(   "flat", "flat_bed_pos", 169, 229, 2, 2)
	...
	register_place(   "hospital", "chair_forward_pos-1", 40, 254, 2, 2)
	register_place(   "hospital", "chair_forward_pos-2", 70, 254, 2, 2)
	...
	register_place(   "houses_1", "houses_1_bench_backward_pos-1", 566, 394, 2, 2)
	register_place(   "houses_1", "houses_1_bench_backward_pos-2", 788, 394, 2, 2)
	register_place(   "houses_1", "houses_1_bench_backward_pos-3", 299, 708, 2, 2)
	register_place(   "houses_1", "houses_1_bench_backward_pos-4", 1116, 704, 2, 2)
	register_place(   "houses_1", "houses_1_bench_backward_pos-5", 1253, 1026, 2, 2)
	register_place(   "houses_1", "houses_1_bench_forward_pos-1", 1327, 443, 2, 2)
	register_place(   "houses_1", "houses_1_bench_forward_pos-2", 250, 1124, 2, 2)
	register_place(   "houses_1", "houses_1_bench_forward_pos-3", 467, 1124, 2, 2)
	register_place(   "houses_1", "houses_1_bench_forward_pos-4", 687, 1124, 2, 2)
	register_place(   "houses_1", "houses_1_bench_with_book_pos", 332, 394, 2, 2)
	register_place(   "houses_1", "houses_1_bench_with_chess_pos", 889, 705, 2, 2)
	register_place(   "houses_1", "houses_1_bench_with_paper_pos", 1337, 704, 2, 2)
	...
	register_location("houses_2", "images/locations/houses_2/", False, 2112, 1470)
	register_place(   "houses_2", "bench_backward_pos-1", 1087, 394, 2, 2)
	register_place(   "houses_2", "bench_backward_pos-2", 1535, 394, 2, 2)
	register_place(   "houses_2", "bench_backward_pos-3", 415, 842, 2, 2)
	register_place(   "houses_2", "bench_backward_pos-4", 799, 842, 2, 2)
	register_place(   "houses_2", "bench_backward_pos-5", 1279, 842, 2, 2)
	register_place(   "houses_2", "bench_backward_pos-6", 319, 1290, 2, 2)
	register_place(   "houses_2", "bench_backward_pos-7", 735, 1290, 2, 2)
	register_place(   "houses_2", "bench_forward_pos-1", 895, 457, 2, 2)
	register_place(   "houses_2", "bench_forward_pos-2", 1311, 457, 2, 2)
	register_place(   "houses_2", "bench_forward_pos-3", 607, 908, 2, 2)
	register_place(   "houses_2", "bench_forward_pos-4", 1023, 908, 2, 2)
	register_place(   "houses_2", "bench_forward_pos-5", 1503, 908, 2, 2)
	register_place(   "houses_2", "bench_forward_pos-6", 511, 1356, 2, 2)
	...
	register_place(   "houses_2", "forest_path-3", 150, 1430, 100, 40, to=["down", "forest_path-3", "houses_2"])
	...
	register_place(   "library", "library_armchair_pos-1", 175, 143, 2, 2)
	register_place(   "library", "library_armchair_pos-2", 345, 143, 2, 2)
	register_place(   "library", "library_chair_left_pos-1", 203, 500, 2, 2)
	register_place(   "library", "library_chair_left_pos-2", 203, 474, 2, 2)
	register_place(   "library", "library_chair_left_pos-3", 362, 479, 2, 2)
	register_place(   "library", "library_cupboard_1_pos", 214, 389, 2, 2)
	register_place(   "library", "library_cupboard_2_pos", 214, 317, 2, 2)
	register_place(   "library", "library_cupboard_3_pos", 215, 248, 2, 2)
	...
	register_place(   "library_and_hospital", "library", 1120, 455, 60, 30, to=["up", "library", "library_and_hospital"])
	...
	register_place(   "radio_storeroom", "radio_storeroom_tabouret_pos", 39, 160, 2, 2)
	...
	register_place(   "scene", "scene_bench_1_pos", 456, 496, 2, 2)
	register_place(   "scene", "scene_bench_2_pos", 456, 557, 2, 2)
	register_place(   "scene", "scene_bench_3_pos", 456, 618, 2, 2)
	register_place(   "scene", "scene_bench_4_pos", 456, 679, 2, 2)
	register_place(   "scene", "scene_bench_5_pos", 456, 740, 2, 2)
	register_place(   "scene", "scene_microphone_pos", 452, 353, 2, 2)
	register_place(   "scene", "scene_sound_pos-1", 196, 325, 2, 2)
	register_place(   "scene", "scene_sound_pos-2", 692, 315, 2, 2)
	register_place(   "scene", "scene_table_pos", 615, 211, 2, 2)
	...
	register_place(   "square", "canteen_bench_pos", 1228, 742, 2, 2)
	...
	register_place(   "square", "washbasin_left_pos-1", 205, 432, 2, 2)
	register_place(   "square", "washbasin_left_pos-2", 205, 671, 2, 2)
	register_place(   "square", "washbasin_right-1", 640, 400, 60, 50)
	register_place(   "square", "washbasin_right-2", 640, 640, 60, 50)
	register_place(   "square", "washbasin_right_pos-1", 688, 432, 2, 2)
	...
	register_place(   "stadium", "stadium_bench_left_pos-1", 1776, 462, 2, 2)
	register_place(   "stadium", "stadium_bench_left_pos-2", 1775, 623, 2, 2)
	register_place(   "stadium", "stadium_bench_left_pos-3", 1774, 752, 2, 2)
	register_place(   "stadium", "stadium_bench_left_pos-4", 1776, 881, 2, 2)
	register_place(   "stadium", "stadium_gates_pos", 1455, 319, 2, 2)
	register_place(   "stadium", "stadium_rails_pos", 671, 831, 2, 2)
	register_place(   "stadium", "stadium_turniks_pos", 879, 127, 2, 2)
	...
	register_place(   "storage", "storage_tabouret_pos", 205, 210, 2, 2)
	...
	register_place(   "tennis", "bench_backward_pos-1", 496, 175, 2, 2)
	register_place(   "tennis", "bench_backward_pos-2", 703, 175, 2, 2)
	register_place(   "tennis", "bench_forward_pos", 575, 607, 2, 2)
	register_place(   "tennis", "tennis_bench_left_pos-1", 938, 306, 2, 2)
	register_place(   "tennis", "tennis_bench_left_pos-2", 938, 434, 2, 2)
	register_place(   "tennis", "tennis_bench_right_pos-1", 442, 306, 2, 2)
	register_place(   "tennis", "tennis_bench_right_pos-2", 442, 434, 2, 2)
	register_place(   "tennis", "tennis_cluster_1_pos", 529, 245, 2, 2)
	register_place(   "tennis", "tennis_cluster_2_pos", 881, 244, 2, 2)
	register_place(   "tennis", "tennis_separator_pos", 708, 373, 2, 2)
