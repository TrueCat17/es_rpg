...
label day_2_cards_continue:
	...
	menu:
		"Играть турнир":
			jump un_play
		"Пропустить турнир (выиграть у Алисы)" if persistent.CardsWon3 else None:
			jump dv_play_win
		"Пропустить турнир (проиграть Алисе)"  if persistent.CardsWon2 else None:
			jump dv_play_fail
		"Пропустить турнир (проиграть Ульяне)" if persistent.CardsWon1 else None:
			jump us_play_fail
...
label day2_main3:
	...
	if day2_card_result == 0:
		...
		window hide
	elif day2_card_result == 1:
		window show
		"Хотя бы один раунд я выиграл."
		window hide
	elif day2_card_result == 2:
		window show
