init -1000 python:
    ...
    dv = Character('Алиса',             unknow_name = 'Пионерка',          color = '#DF9501')
    un = Character('Лена',              unknow_name = 'Пионерка',          color = '#B956FF')
    sl = Character('Славя',             unknow_name = 'Пионерка',          color = '#F3F301')
    mi = Character('Мику',              unknow_name = 'Пионерка',          color = '#00DEFF')
    us = Character('Ульяна',            unknow_name = 'Пионерка',          color = '#FF3200')
    
    mz = Character('Женя',              unknow_name = 'Пионерка',          color = '#4983F9')
    mt = Character('Ольга Дмитриевна',  unknow_name = 'Вожатая',           color = '#00EA32')
    cs = Character('Виола',             unknow_name = 'Медсестра',         color = '#9B9CEF')
    el = Character('Электроник',        unknow_name = 'Пионер',            color = '#F3F301')
    sh = Character('Шурик',             unknow_name = 'Пионер',            color = '#F3F301')
    uv = Character('Юля',               unknow_name = 'Странная девочка',  color = '#FFFF00')
